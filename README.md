...
[📥 下载最新版本 (v1.3.0)](https://github.com/MacIsland/MacIsland/releases/download/v1.3.0/MacIsland_v1.3.0.dmg)
...
### 优化设置
- ✅ **设置面板重构**：10 个分类（外观/壁纸/动画/剪贴板/音乐/天气/通知中心/社区/快捷键/关于），侧栏导航 + 搜索过滤，设置项描述与提示
